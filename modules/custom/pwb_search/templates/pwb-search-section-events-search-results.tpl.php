...
<li class="<?php print $classes; ?> <?php print (isset($item_class)) ? $item_class : ''; ?>"<?php print $attributes; ?>>
  ...
  <?php if (isset($result_location)) { ?>
    <div class="list-item-location"><?php print t('Location:') . ' ' . $result_location; ?></div>
  <?php } ?>

  <?php if (isset($result_dates)): ?>
    <div class="text-secondary"><?php print $result_dates; ?></div>
  <?php endif; ?>
</li>
